...
public class EMMA {
    ...
    public static func getSDKVersion() -> String{
        return "" // returns the current SDK Version
    }
    ...
    /// This method enables communication between SDK and EMMA on previously disabled user. If already enabled, does nothing
    ...
    /// This method gets the install attribution info. The response can have three status for attribution: `pending`, `organic` or `campaign`
    ///
    ...
    ///Method opens the native ad on browser or inapp webview whatever EMMA dashboard configuration
    ///
    ///- Parameter nativeAdCampaignId: The campaign identifier
    ...
    /// Registers a user on EMMA's database with a unique user identifier and an optional email address.
    ///
    ...
    ///Cancel the order referenced by an order id.
    ///
    ///If your e-commerce allows canceling orders, this method updates the purchases data with the cancelled orders.
    ...
    ///
    /// > Important:
    /// To enable push notifications, you must generate and configure the appropriate push certificates for your app.
    ...
    */
    ...
    ///
    ///- Parameters content: notification content
    ...
    */
    ...
    ///This method, sets the domain where the webApp is hosted without the (http://) Example: www.example.com
    ///
    ...
    ///This method allows add your custom in-app plugins.
    ///
    ...
    // TODO: not previously documented, check
    ...
    // TODO: no estaba documentado previamente, chequear
